...
class ExceptionLivresGenresAfficher(Base):
    pass


class ExceptionEditGenreLivreSelected(Base):
    pass


class ExceptionUpdateGenreLivreSelected(Base):
    pass


class ExceptionGenresLivresAfficherData(Base):
    pass


class ExceptionLivreUpdateWtf(Base):
    pass


class ExceptionLivreDeleteWtf(Base):
    pass


class ExceptionInitAppLivres164(Base):
    pass
